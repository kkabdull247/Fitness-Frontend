  ...
  const getmealbyId = async () => {
    try {
      ...
      fetch(`http://localhost:3000/meal/getmealbyid/${id}`, {
        ...
        .then(res => res.json())
        .then(data => {
          setMealName(data.meal.mealName);
          setSelectedFood(data.meal.food._id);
          setQuantity(data.meal.quantity);
          setMealType(data.meal.mealType || 'Breakfast');
        })
    } catch (error) {
      console.log(error)
    }
    ...
    <div className="fitness-page">
      ...
      <div className="track-card">
        ...
        <div className="mb-5">
          ...
          <h2 className="section-title mb-1">Edit Your Meal</h2>
